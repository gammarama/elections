...
{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\\Error in format(min(spend.data\$exp\_amo, na.rm = TRUE), nsmall = 2, scientific = FALSE) : \\  object 'spend.data' not found}} \newline
Max: \$
...
{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\\Error in median(spend.data\$agg\_amo, na.rm = TRUE) : \\  object 'spend.data' not found}}\\
