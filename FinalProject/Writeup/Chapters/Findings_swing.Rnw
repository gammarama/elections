...
<<type_swing_1, echo=FALSE, warning=FALSE, fig.width=10, fig.height=6, out.width='\\textwidth', fig.align='center', fig.pos='H', fig.cap='Polling Averages for Obama and Romney by swing state'>>=
