...
<<type_plot, echo=FALSE, warning=FALSE, fig.width=4, fig.height=4, out.width='.4\\textwidth', fig.pos='H', fig.align='center', fig.cap='Types of spending by category for Romney and Obama Super PACs', fig.show='hold'>>=
