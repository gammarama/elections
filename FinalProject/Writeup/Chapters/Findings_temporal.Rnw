...
<<temporal_plot, echo=FALSE, warning=FALSE, fig.width=10, fig.height=8, out.width='\\textwidth', fig.align='center', fig.pos='H', fig.cap='Spending by Super PACs in support or opposition of candidates'>>=
