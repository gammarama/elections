...
Min: \$\Sexpr{format(min(spend.data$exp_amo, na.rm=TRUE), nsmall=2, scientific=FALSE)} \newline
Max: \$\Sexpr{format(max(spend.data$exp_amo, na.rm=TRUE), nsmall=2, scientific=FALSE)} \newline
Mean: \$\Sexpr{format(mean(spend.data$exp_amo, na.rm=TRUE), nsmall=2, scientific=FALSE)} \newline
Median: \$\Sexpr{format(median(spend.data$exp_amo, na.rm=TRUE), nsmall=2, scientific=FALSE)}\\
