...
<<type_swing_1, echo=FALSE, warning=FALSE, fig.width=10, fig.height=10, out.width='\\textwidth', fig.align='center', fig.pos='H', fig.cap='Polling averages for Mr. Obama and Mr. Romney by swing state. Important events are indicated as follows: (1) Paul Ryan VP selection, (2) Republican National Convention, (3) Democratic National Convention, (4) 47% video leaked, (5) first presidential debate, and (6) election day.'>>=
swingPlot
@
