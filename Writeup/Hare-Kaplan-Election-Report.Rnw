...
\section{Findings}
<<ch3-findings-1, child='Chapters/Findings_type.Rnw', eval=TRUE>>=
@

<<ch3-findings-2, child='Chapters/Findings_swing.Rnw', eval=TRUE>>=
@

<<ch3-findings-3, child='Chapters/Findings_temporal.Rnw', eval=TRUE>>=
@
